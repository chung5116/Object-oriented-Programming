...
Creature::Creature(Board& bd, char gCIconRecord, int gCPosRecordx, int gCPosRecordy, int gChp) {
	this->boardHeight = bd.height;
	this->icon = gCIconRecord;
	this->exist = false;
	this->posCreature.x = gCPosRecordx;
	this->posCreature.y = gCPosRecordy;
	this->hp = gChp;
}
