...
extern const int gnumOfCreature;
...
public:
	...
	void drawAttckRange(vector<Creature>& gCreature);
...
public:
	...
	Creature(Board& bd, char gCIconRecord, int gCPosRecordx, int gCPosRecordy,int gChp);
